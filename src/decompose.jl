...
decompose{FT, IndexOffset}(T::Type{Face{3, FT, IndexOffset}}, r::SimpleRectangle) = T[
...
decompose{FT, IndexOffset}(T::Type{Face{3, FT, IndexOffset}}, r::Pyramid) = reinterpret(T, collect(map(FT,(1:18)+IndexOffset)))
