...
call{T, Offset, S <: AbstractString}(::Type{Face3{T, Offset}}, x::Union(Vector{S}, Tuple{S})) = Face3{T, Offset}(parse(T, x[1]), parse(T, x[2]), parse(T, x[3]))
call{T, Offset, S <: AbstractString}(::Type{Face4{T, Offset}}, x::Union(Vector{S}, Tuple{S})) = Face4{T, Offset}(parse(T, x[1]), parse(T, x[2]), parse(T, x[3]), parse(T, x[4]))
...
convert{T, IndexOffset1}(::Type{Face3{T, IndexOffset1}}, f::Face3{T, IndexOffset1}) = f
convert{T, IndexOffset1, IndexOffset2}(t::Type{Face3{T, IndexOffset1}}, f::Face3{T, IndexOffset2}) = t((f+IndexOffset1-IndexOffset2)...)
