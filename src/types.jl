...
@gen_fixed_size_vector("Vector", 	[:x,:y,:z,:w],              2:4, false)
@gen_fixed_size_vector("Point",  	[:x,:y,:z,:w], 				2:4, false)
@gen_fixed_size_vector("Normal",  	[:x,:y,:z,:w], 				2:4, false)
...
@gen_fixed_size_vector("Vector",    [:x,:y,:z,:w],              2:4, true)
@gen_fixed_size_vector("Point",     [:x,:y,:z,:w],              2:4, true)
@gen_fixed_size_vector("Normal",    [:x,:y,:z,:w],              2:4, true)
...
gen_fixed_size_matrix(2:4, 2:4, false)
gen_fixed_size_matrix(2:4, 2:4, true)
